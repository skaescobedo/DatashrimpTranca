  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={openCreate}
          className="flex items-center cursor-pointer gap-2 px-4 py-2.5 rounded-xl text-white text-sm transition-all hover:opacity-90"
                ...
                <tr key={e.id} className="border-b border-slate-50 hover:bg-sky-50/50 transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <div className="flex items-center gap-1">
                      <button onClick={() => openView(e)} className="p-1.5 rounded-lg cursor-pointer text-slate-400 hover:text-cyan-600 hover:bg-cyan-50 transition-colors" title="Ver">
                        <Eye className="h-4 w-4" />
                      </button>
                      <button onClick={() => openEdit(e)} className="p-1.5 rounded-lg cursor-pointer text-slate-400 hover:text-amber-600 hover:bg-amber-50 transition-colors" title="Editar">
                        <Pencil className="h-4 w-4" />
                      </button>
                      <button onClick={() => setDeleteId(e.id)} className="p-1.5 rounded-lg cursor-pointer text-slate-400 hover:text-red-600 hover:bg-red-50 transition-colors" title="Eliminar">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button onClick={closeModal} disabled={actionLoading} className="flex-1 py-2.5 rounded-xl text-sm border border-slate-200 text-slate-600 cursor-pointer hover:bg-slate-50">Cancelar</button>
            <button onClick={handleSave} disabled={actionLoading} className="flex-1 py-2.5 rounded-xl text-sm cursor-pointer text-white" style={{ backgroundColor: '#0e7490', fontWeight: 500 }}>
